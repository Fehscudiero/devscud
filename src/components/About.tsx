...
const About = () => {
  ...
  // PADRÃO CONTATO: Range de movimento sincronizado
  ...
  return (
    ...
    >
      ...
      {/* MARCA D'ÁGUA PADRONIZADA - POSICIONADA NO TOPO DIREITO */}
      <div className="absolute top-0 left-0 w-full overflow-hidden pointer-events-none select-none z-0">
        <motion.h2
          style={{ x: textX }}
          className={`text-[15vw] font-black leading-none tracking-tighter uppercase opacity-[0.03] dark:opacity-[0.05] whitespace-nowrap text-right pr-10 ${isDarkTheme ? 'text-white' : 'text-black'}`}
        >
          SOBRE
        </motion.h2>
      </div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        {/* HEADER */}
        <div className="relative mb-20 flex flex-col items-center lg:items-start lg:text-left">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            <h3 className={`text-6xl sm:text-8xl font-black ${titleColorClass} tracking-tighter leading-none relative z-10`}>
              <br />
              <span className={`
                text-left 
                bg-gradient-to-r ${gradientText} bg-clip-text text-transparent 
                italic underline decoration-cyan-500/20
                md:pr-4 md:-ml-2`}>
                DESENVOLVEDOR
              </span>
            </h3>
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          {/* FOTO E CONTEÚDO CONTINUAM IGUAIS... */}
